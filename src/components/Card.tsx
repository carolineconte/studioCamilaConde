  ...
  return (
    ...
    md:flex-col md:size-full md:items-center md:px-1">
      ...
      <div className="max-[376px]:justify-between max-[376px]:pt-0 flex flex-col gap-2 justify-around pt-3 md:grow md:pt-1">
        ...
        <button className="text-[1em] font-semibold shadow border-2 border-primaryBlack text-primaryBlack drop-shadow-lg rounded-md px-4 py-1 mt-2 mx-auto block md:mt-auto cursor-pointer hover:bg-primaryBlack hover:text-white">Saiba mais</button>
      </div>
    </div>
  )
}
